...
CREATE TABLE `routine_checkups` (
  ...
  `BloodPressure_Systolic` varchar(255) DEFAULT NULL,
  `BloodPressure_Diastolic` varchar(255) DEFAULT NULL,
  `BodyTemperature` varchar(255) NOT NULL,
  `PostPranDialSugar` varchar(255) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `routine_checkups_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
